...
def buscaocurrencias (vbuscado):
    import re
    print(re.findall("python",texto.lower()))
    a = texto.lower()
    r=a.count(vbuscado)
    if r>0:
        print("El número de veces que se encontró la palabra '",vbuscado,"' en el texto es: ",r)
    else:
        print("La palabra ingresada no se encontra en el texto")
